...
;
;
; match-colours.scm    version 0.1    September 12, 2007
...
(define (script-fu-match-colors img drawable master-img)
  (let* (
    ...
    ;Add check to make sure original image only has a single layer?
    ...
    ;Step 3
    ;Should add a check to see if copy returned true
