           ...
           (let* ((filename (car filelist))
             ...
             (if (= is_black TRUE)
                 ( begin
                    ...
                    (gimp-image-select-ellipse img x_black y_black radius radius ADD TRUE TRUE (* radius 0.2)) ;last term is feather strength
                ...
                (begin
                  ...
                  (if (> grain 0)
                      (begin
                        ...
                        (gimp-image-lower-item img SharpenLayer)
                        )
                      )
                  )
                )
